    ...
    <div className="max-w-2xl pl-8 md:pl-16 lg:pl-24 mt-16"> {/* Added mt-16 here */}
      ...
      <section className="py-8 flex justify-center items-center h-[60vh] bg-gray-100">
        <div className="container mx-auto text-center">
          <p className="text-2xl text-gray-600">Empowering Businesses with Smart Solutions Since 2008
...
With over a decade of experience, we’ve built a reputation for excellence across diverse industries — from customer support services to cutting-edge software products. Our dynamic team combines technical expertise with business insights to help you achieve your goals efficiently and effectively.</p>
        </div>
      </section>
